...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Activity.LoadLayout(\"layout1\")";
mostCurrent._activity.LoadLayout("layout1",mostCurrent.activityBA);
 //BA.debugLineNum = 25;BA.debugLine="UDP.Initialise(3200)";
...
String _message = "";
 ...
 //BA.debugLineNum = 30;BA.debugLine="Dim emission() As Byte";
_emission = new byte[(int) (0)];
;
 //BA.debugLineNum = 31;BA.debugLine="Dim bc As ByteConverter";
_bc = new anywheresoftware.b4a.agraham.byteconverter.ByteConverter();
 //BA.debugLineNum = 32;BA.debugLine="Dim message As String";
_message = "";
 //BA.debugLineNum = 33;BA.debugLine="message=EditText1.Text";
_message = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 34;BA.debugLine="emission=bc.StringToBytes(message,\"ASCII\")";
_emission = _bc.StringToBytes(_message,"ASCII");
 //BA.debugLineNum = 35;BA.debugLine="UDP.emission(\"192.168.1.205\",5500,emission)";
...
String _message = "";
 //BA.debugLineNum = 38;BA.debugLine="Sub UDP_PacketArrived (packet As UDPPacket)";
 //BA.debugLineNum = 40;BA.debugLine="Dim message As String";
_message = "";
 //BA.debugLineNum = 41;BA.debugLine="message=UDP.reception(packet)";
_message = mostCurrent._udp._reception(mostCurrent.activityBA,_packet);
 //BA.debugLineNum = 42;BA.debugLine="Label1.Text=message";
