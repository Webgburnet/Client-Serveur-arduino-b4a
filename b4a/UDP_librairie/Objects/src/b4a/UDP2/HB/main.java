...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.UDP2.HB", "b4a.UDP2.HB.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.UDP2.HB", "b4a.UDP2.HB.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.UDP2.HB.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._activity.LoadLayout("layout1",mostCurrent.activityBA);
 //BA.debugLineNum = 30;BA.debugLine="UDP.Initialise(3200)";
...
anywheresoftware.b4a.agraham.byteconverter.ByteConverter _bc = null;
 ...
 //BA.debugLineNum = 44;BA.debugLine="Dim data(2) As Byte";
_data = new byte[(int) (2)];
;
 //BA.debugLineNum = 45;BA.debugLine="Dim bc As ByteConverter";
_bc = new anywheresoftware.b4a.agraham.byteconverter.ByteConverter();
 //BA.debugLineNum = 46;BA.debugLine="data=bc.StringToBytes(EditText1.Text,\"utf-8\")'\"Bo";
_data = _bc.StringToBytes(mostCurrent._edittext1.getText(),"utf-8");
 //BA.debugLineNum = 47;BA.debugLine="UDP.emission(Adressepc,5500,data)'cles wifi";
mostCurrent._udp._emission(mostCurrent.activityBA,_adressepc,(int) (5500),_data);
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 53;BA.debugLine="Adressepc=EditText2.text";
_adressepc = mostCurrent._edittext2.getText();
...
String _message = "";
 //BA.debugLineNum = 35;BA.debugLine="Sub UDP_PacketArrived (packet As UDPPacket)";
 //BA.debugLineNum = 37;BA.debugLine="Dim message As String";
_message = "";
 //BA.debugLineNum = 38;BA.debugLine="message=UDP.reception(packet)";
_message = mostCurrent._udp._reception(mostCurrent.activityBA,_packet);
 //BA.debugLineNum = 39;BA.debugLine="Label1.Text=message";
